...
namespace RaysHotDogs
{
    ...
    public class HotDogMenuActivity : Activity
    {
        ...
        private void HotDogListView_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            StartActivityForResult(intent, 100); //Note this code for return
        }

        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data) //This void handles the return from the details activity
        {
            base.OnActivityResult(requestCode, resultCode, data);

            if (resultCode == Result.Ok && requestCode == 100) //Returned code 100
            {
